...
#Region "Custom Paging-Related Methods"
    ...
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function GetProductsPaged(ByVal startRowIndex As Integer, ByVal maximumRows As Integer) As Northwind.ProductsDataTable
        Return Adapter.GetProductsPaged(startRowIndex, maximumRows)
    End Function

    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function GetProductsPagedAndSorted(ByVal sortExpression As String, ByVal startRowIndex As Integer, ByVal maximumRows As Integer) As Northwind.ProductsDataTable
...
#Region "Default Paging-Related Methods (needed for the DataList and Repeater)"
    ...
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function GetProductsSortedAsPagedDataSource(ByVal sortExpression As String, ByVal pageIndex As Integer, ByVal pageSize As Integer) As PagedDataSource
        ' Get ALL of the products
        Dim products As Northwind.ProductsDataTable = GetProducts()
...
#Region "UpdateProduct Overloads"
    ...
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, False)> _
    Public Function UpdateProduct(ByVal productName As String, ByVal categoryID As Nullable(Of Integer), ByVal supplierID As Nullable(Of Integer), ByVal discontinued As Boolean, ByVal productID As Integer) As Boolean
        Dim products As Northwind.ProductsDataTable = Adapter.GetProductByProductID(productID)
        If products.Count = 0 Then
            ' no matching record found, return false
            Return False
    ...
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, False)> _
    Public Function UpdateProduct(ByVal productName As String, ByVal quantityPerUnit As String, ByVal productID As Integer) As Boolean
        Dim products As Northwind.ProductsDataTable = Adapter.GetProductByProductID(productID)
    ...
    Public Function UpdateProduct(ByVal unitPriceAdjustmentPercentage As Decimal, ByVal productID As Integer) As Boolean
        Dim products As Northwind.ProductsDataTable = Adapter.GetProductByProductID(productID)
...
#End Region
    ...
    Public Function DiscontinueAllProductsForSupplier(ByVal supplierID As Integer) As Integer
