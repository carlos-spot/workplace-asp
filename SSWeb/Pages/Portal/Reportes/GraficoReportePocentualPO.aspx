<%@ Page Language="VB" MasterPageFile="~/Pages/Portal/PrincipalPortal.master" AutoEventWireup="false" CodeFile="GraficoReportePocentualPO.aspx.vb" Inherits="Pages_Rol_2___Profesor_Confeccion_GraficoReportePocentual" title="Gráfico de porcentaje de respuestas tabuladas" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContenedorPortal" Runat="Server">
    <div id="p" style="height: 596px">
         <br />
        <div>
        ...
        style="height: 190px; margin-top: 23px; width: 778px; margin-left: 93px; margin-right: 0px;">
            ...
            <div style="text-align: right; margin-top: 284px">
                     ...
                     <asp:Button ID="btnAtras" runat="server" Text="Regresar" style="margin-left: 0px; margin-right: 50px;" 
