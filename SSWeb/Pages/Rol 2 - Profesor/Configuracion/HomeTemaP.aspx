<%@ Page Language="VB" MasterPageFile="~/Pages/Rol 2 - Profesor/PrincipalProfesor.master" AutoEventWireup="false" CodeFile="HomeTemaP.aspx.vb" Inherits="Pages_Rol_2___Profesor_HomeTemaP" title="Principal tema" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPrincipal" Runat="Server">
    <div id="Contenedor" style="width: 979px; font-size: 16px; text-align:justify; padding-top: 10px; height: 557px; ">
        ...
        <div style="height: 87px; float:right; width: 170px; text-align: left; margin-top: 187px; margin-right: 72px; margin-left: 0px;">
            ...
            <br />
                <asp:Button ID="btnConfigurar" runat="server" Height="38px" 
                    Text="Configurar temas" Width="154px" />
            </div>
        </div>
