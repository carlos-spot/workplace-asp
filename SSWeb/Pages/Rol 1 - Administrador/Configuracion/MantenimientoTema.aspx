<%@ Page Language="VB" MasterPageFile="~/Pages/Rol 1 - Administrador/PrincipalAdministrador.master" AutoEventWireup="false" CodeFile="MantenimientoTema.aspx.vb" Inherits="Pages_Rol_1___Administrador_MantenimientoTema" title="Configuración de temas" %>
<%@ Register assembly="obout_Grid_NET" namespace="Obout.Grid" tagprefix="cc1" %>
<%@ Register assembly="obout_Interface" namespace="Obout.Interface" tagprefix="cc2" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>

<asp:Content ID="ContenedorTema" ContentPlaceHolderID="ContentPrincipal" Runat="Server">
    ...
    <div id="PrincipaL" style="background-color:Transparent; width: 983px; height: 556px; margin-left: 0px; margin-right: auto; margin-top: 0px;" >
        <div id="derechaDiv1" style="float:right; height: 2px; width: 139px; margin-left: 0px; margin-top: 25px;"></div>
        <%--Div con el titulo de la pagina--%>
        <div id="DivTitulo" style="float:left; height: 39px; width: 837px; margin-top: 25px;">
            <div id="Div3" style="height: 29px; width: 593px; text-align: center; margin-left: 141px; margin-top: 7px;">
                <asp:Label ID="lblMantenimiento" runat="server" Enabled="False" Font-Names="Arial" Font-Size="20pt" ForeColor="#000066" 
                    Text="Registrar un tema"></asp:Label>
            </div>
        </div>
        
        <%--Div con los botones de "Guardar al registrar", "Guardar al modificar", "Limpiar los datos"--%>
        <div id="DivBotones" style="float:right; height: 165px; width: 137px;">
        ...
        <div id="DivDatos" style="float:left; height: 128px; width: 837px;">
            <div id="DivDatosTema" style="height: 87px; border: medium dotted #74B7DE; background-color: #D4D4D4; width: 717px; margin-left: 79px; text-align: center;">
                <%--Campo para el nombre del tema--%>
                <div id="DivNombreTema" 
                    style="float:left; margin: 0px auto 0px 0px; height: 51px; width: 714px;" >
                <div id="DivSubNombreTema"  style="float:left; width: 257px; height: 47px; margin-left: 241px; margin-top: 7px; text-align: left;">
                    <asp:Label ID="lblNombre" runat="server" Font-Size="11pt" Text="Nombre para el nuevo tema:"></asp:Label>
                ...
                <div id="SubDivMensajeError" style="float:inherit; width: 686px; height: 18px; margin-left: 0px; margin-top: 7px;">
        ...
        <div id="derechaDiv3" style="float:right; height: 36px; width: 88px; margin-left: 0px;"></div>
        
        <%--Div que contiene el campo para buscar los temas--%>
            ...
            <div id="subDivBuscar" style=" float:left; margin: 2px auto 0px 0px; background-color:Transparent; height: 50px; width: 832px;" >
                <div id="DivLblBuscar" style="float:left; height: 39px; width: 487px; margin-left: 143px;">
                    ...
                    <asp:Label ID="lblCriterio" runat="server" Font-Size="11pt" 
                        Text="Ingrese el nombre del tema:"></asp:Label>
                    &nbsp;
                    <asp:TextBox ID="txtCriterio" runat="server" Height="20px" Width="220px" 
                        style="margin-left: 0px; margin-top: 0px;" CausesValidation="True"></asp:TextBox>
                </div>
        ...
        <div id="divMensajeBusqueda" style="float:left; height: 21px; width: 868px; text-align: center;">
            <asp:Label ID="lblMensajeBuscar" runat="server" Font-Size="11pt" ForeColor="#FF3300"></asp:Label>
        </div>
        ...
        <%--Div que contiene la tabla donde mostraremos los datos de los temas--%>
        <div id="DivTablaGrind" style="float:left; height: 198px; width: 839px;">
            <div id="SubDivTablaGrind" style="background-color:Transparent; height: 193px; text-align: left; margin-left: 191px; width: 557px; margin-top: 0px;">
                <cc1:Grid ID="tablaGrind" runat="server" AllowPageSizeSelection="False" PageSize="0" 
                    ...
                    <LocalizationSettings NoRecordsText="No se encontraron temas registrados." 
                        Paging_ManualPagingLink="Ir a la página »" Paging_OfText="de" 
                        Paging_PageSizeOptions_All="Todoas" Paging_PagesText="Página:" />
                </cc1:Grid>
           </div>
        </div>
        ...
        <div id="divConfirmaciones" style="float:left; height: 31px; width: 840px;">
           <div style="display:run-in;">
                ...
                <asp:Panel ID="PNL" runat="server" Height="70px" Width="387px" style=" display:none; background-color:White; border-width:2px; border-color:Black; border-style:solid; padding:20px;" 
                    ...
                    <asp:Label ID="lblMensajeConfirm" runat="server" Font-Size="11pt"  Text="¿Estas seguro de que deseas elimiar este tema?"></asp:Label>
                    <br /><br />
