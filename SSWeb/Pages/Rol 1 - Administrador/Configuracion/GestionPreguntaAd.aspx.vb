...
Partial Class Pages_Rol_1___Administrador_Configuracion_GestionPreguntaAd
    ...
    Protected Sub btnCancelar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancelar.Click
        ...
        ElseIf lblMod.Text.Equals("Modificar pregunta") Then
            Response.Redirect("PilaPreguntasAd.aspx?")
        Else
            limpiarForm()
            lblError.Visible = False
        End If
    ...
    Protected Sub btnRegresar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegresar.Click
        Me.Response.Redirect("PilaPreguntasAd.aspx")
    End Sub
End Class
