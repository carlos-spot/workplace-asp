<%@ Page Title="" Language="VB" MasterPageFile="~/Pages/Rol 1 - Administrador/PrincipalAdministrador.master" AutoEventWireup="false" CodeFile="VerInfoEstadisticaAd.aspx.vb" Inherits="Pages_Rol_1___Administrador_Configuracion_VerInfoEstadisticaAd" %>
        ...
        style="margin:0px auto 0px 1px; height: 454px; width: 966px;" >
            ...
            <div id="menu" 
                ...
                <asp:Button ID="bTabular" runat="server" Text="Ver resultados" Enabled="true" 
                    style="margin-top: 4px" Width="148px" Height="35px" 
