<%@ Page Title="Mantenimiento de tema" Language="VB" MasterPageFile="~/Pages/Rol 1 - Administrador/PrincipalAdministrador.master" AutoEventWireup="false" CodeFile="HomeTema.aspx.vb" Inherits="Pages_Funcionalidades_MantenimientoTema" %>
        ...
        <div style="height: 87px; float:right; width: 170px; text-align: left; margin-top: 187px; margin-right: 72px; margin-left: 0px;">
            ...
            <br />
                <asp:Button ID="btnConfigurar" runat="server" Height="25px" 
                    Text="Configurar temas" Width="130px" />
            </div>
        </div>
