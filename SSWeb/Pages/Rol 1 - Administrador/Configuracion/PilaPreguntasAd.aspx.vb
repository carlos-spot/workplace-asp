...
Partial Class Pages_Rol_1___Administrador_Configuracion_PilaPreguntasAd
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Response.Redirect("GestionPreguntaAd.aspx?id=" & 1)
    End Sub
            ...
            If Not listaRecords.Count > 1 Then
                Try
                    ...
                    If (esModificable = True) Then
                        ...
                        Response.Redirect("GestionPreguntaAd.aspx?id=" & 2)
                    Else
