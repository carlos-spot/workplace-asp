<%@ Page Language="VB" MasterPageFile="~/Pages/Rol 1 - Administrador/PrincipalAdministrador.master" AutoEventWireup="false" CodeFile="VistaReporteComparacion.aspx.vb" Inherits="Pages_Rol_1___Administrador_Reportes_VistaReporteComparacion" title="Reporte comparativo" %>
    ...
    <div id ="DivPrincipal" style="height: 604px">
        ...
        <div style="text-align: right">
            <asp:Button ID="btnRegresar" runat="server" Text="Regresar" Height="26px" 
                style="margin-right: 32px" Width="87px" />
        </div>
    </div>
</asp:Content>
