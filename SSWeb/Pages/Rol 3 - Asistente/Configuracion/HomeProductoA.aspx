<%@ Page Language="VB" MasterPageFile="~/Pages/Rol 3 - Asistente/PrincipalAsistente.master" AutoEventWireup="false" CodeFile="HomeProductoA.aspx.vb" Inherits="Pages_Rol_3___Asistente_HomeProductoA" title="Mantenimiento de productos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPrincipal" Runat="Server">
       <div id="Contenedor" style="width: 982px; font-size: 16px; text-align:justify; padding-top: 10px; height: 561px; ">
        ...
        <div style="height: 87px; float:right; width: 170px; text-align: left; margin-top: 122px; margin-right: 72px; margin-left: 0px;">
